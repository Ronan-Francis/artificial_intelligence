...
public class AutoMPGRegression {
    ...
    public static String LOCAL_URL = "/workspaces/artificial_intelligence/AutoMPGRegression/auto-mpg.csv";
	...
	public void run(String[] args) {
		try {
            ...
            File filename = loadData(LOCAL_URL);
			
			// Define the format of the data file.
			// This area will change, depending on the columns and 
			// format of the file that you are trying to model.
			CSVFormat format = new CSVFormat('.',','); // decimal point and space separated (CHANGED TO)
			...
			while(csv.next()) {
                ...
                double mse = Math.abs(Double.parseDouble(correct) - Double.parseDouble(predictedMPG));
            ...
            System.out.println("Average error: " + totalError/l);
